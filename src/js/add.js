...
//   else if(v.phone.charCodeAt(0) < 48 || v.phone.charCodeAt(0) > 57) {alert("휴대폰 번호는 숫자를 입력해주세요"); return;}
//   else if(v.phone.length < 11)  {alert("휴대폰 번호를 정확히 입력해주세요"); return;}
...
//   else if(v.adult + v.kid + v.baby == 0) {alert("투어 인원을 선택해주세요"); return;}
  ...
  $("#bill > tbody").append(
    "<tr id=\'added" + global_index + "\'>" +
    "<td class=\'col_1\'>" + v.sel_1 + "/<br>" + v.sel_2 + "</td>" +
